...
@section('content')
    <div class="col-sm-8">
        <blockquote>
            <p><img src="{{ $user->avatar }}" alt="" class="img-rounded" style="border-radius:300px; height: 40px"> {{ $user->name }}
            </p>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_1">
                        ...
                        <div class="blog-post" style="margin-top: 30px">
                            <p class=""><a href="">{{ $post->user->name }}</a> {{ $post->created_at->diffForHumans() }}</p>
